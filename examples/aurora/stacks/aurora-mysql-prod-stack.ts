...
/**
 * Example stack for deploying Aurora MySQL in a production environment.
 *
 * @remarks
 * This stack demonstrates production-ready Aurora MySQL deployment with:
 ...
 */
export class AuroraMySqlProdStack extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const config = ConfigResolver.getMySqlProdConfig();
