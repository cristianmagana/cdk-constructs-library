...
/**
 * Creates an Aurora PostgreSQL cluster with CloudWatch Database Insights support.
 *
 * @remarks
 * This construct creates a production-ready Aurora PostgreSQL cluster with:
 ...
 * @param props - Configuration properties for the PostgreSQL cluster
 ...
 * ```
 *
 * @see {@link AuroraPostgresClusterProps} for configuration options
 * @see https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_DatabaseInsights.html
 * @public
 */
export const createAuroraPostgresCluster = (scope: Construct, props: AuroraPostgresClusterProps): ClusterResources => {
    ...
    const securityGroup = createAuroraSecurityGroup(scope, `${props.clusterName}-sg`, vpc, 5432, props);
